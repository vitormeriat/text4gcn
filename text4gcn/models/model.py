...
class GCN(nn.Module):
    def __init__(self, input_dim, output_dim, support, dropout_rate=0., num_classes=10):
        super(GCN, self).__init__()

        # GraphConvolution
        self.layer1 = GraphConvolution(
            input_dim, output_dim, support, act_func=nn.ReLU(), featureless=True, dropout_rate=dropout_rate)

        self.layer2 = GraphConvolution(
            output_dim, num_classes, support, dropout_rate=dropout_rate)
